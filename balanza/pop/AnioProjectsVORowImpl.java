...
// ---------------------------------------------------------------------
public class AnioProjectsVORowImpl extends OAViewRowImpl {
    public static final int CODE = 0;
    public static final int MEANING = 1;

    /**This is the default constructor (do not remove)
     */
    public AnioProjectsVORowImpl() {
    }
     ...
     */
    public Number getMeaning() {
        return (Number) getAttributeInternal(MEANING);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute Meaning
     */
    public void setMeaning(Number value) {
